...
from .views import home, aboutus,  dashboard, profile, preferred_currency, notification, settings, notification_detail, mark_all_as_read, phoneNumberLogin, addPhoneNumber, changeUserName
